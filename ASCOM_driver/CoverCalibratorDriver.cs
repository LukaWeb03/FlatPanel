...
//
// ASCOM CoverCalibrator driver for FlatPanel
//
...
namespace ASCOM.FlatPanel
{
    //
    // Your driver's DeviceID is ASCOM.FlatPanel.CoverCalibrator
    //
    // The Guid attribute sets the CLSID for ASCOM.FlatPanel.CoverCalibrator
    // The ClassInterface/None attribute prevents an empty interface called
    // _FlatPanel from being created and used as the [default] interface
    //
    ...
    /// ASCOM CoverCalibrator Driver for FlatPanel.
    /// </summary>
    [Guid("0bcea2e7-316e-4f71-88e3-42d5f2242ee4")]
    ...
    public class CoverCalibrator : ICoverCalibratorV1
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.FlatPanel.CoverCalibrator";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM CoverCalibrator Driver for FlatPanel.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlatPanel"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public CoverCalibrator()
        {
            tl = new TraceLogger("", "FlatPanel");
